  ...
  (defun color-theme-decklin-dark ()
    ...
    (color-theme-install
     '(color-theme-decklin-dark
       ...
       (font-lock-comment-delimiter-face ((t (:foreground "#dc33b3bbaa3e"))))
       (font-lock-comment-face ((t (:foreground "#d14ab69196bd"))))
       (font-lock-constant-face ((t (:foreground "#d381aa81a1aa"))))
       (font-lock-doc-face ((t (:foreground "#aaefbaaea2b5"))))
