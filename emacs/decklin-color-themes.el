  ...
  (color-theme-install
   '(color-theme-decklin
     ((background-color . "white")
      ...
      (viper-emacs-state-cursor-color . "black")
      (viper-insert-state-cursor-color . "purple")
      (viper-replace-overlay-cursor-color . "orange")
      (viper-saved-cursor-color-in-replace-mode . "green")
      (viper-vi-state-cursor-color . "blue3")
