    ...
    (color-theme-install
     '(color-theme-decklin-tty
       ((background-mode . dark)
        ...
        (list-matching-lines-face . match)
        (view-highlight-face . highlight))
       (default ((t (:inverse-video nil :strike-through nil :overline nil :underline nil :slant normal :weight normal))))
       (bold ((t (:bold t :weight bold))))
       (bold-italic ((t (:italic t :bold t :slant italic :weight bold))))
       (border ((t (nil))))
       (buffer-menu-buffer ((t (:bold t :weight bold))))
       ...
       (flyspell-incorrect ((t (:foreground "red" :bold t))))
       (flyspell-duplicate ((t (:foreground "green" :bold t))))
       ...
       (font-lock-string-face ((t (:foreground "#14f542310000"))))
       ...
       (underline ((t (:underline t))))
       (vertical-border ((t (nil))))
       (viper-minibuffer-emacs ((t (:foreground "default" :background "default" :bold t))))
       (viper-minibuffer-insert ((t (:foreground "default" :background "default" :bold t))))
       (viper-minibuffer-vi ((t (:foreground "default" :background "default" :bold t))))
       (viper-replace-overlay ((t (:foreground "default" :background "default" :bold t))))
